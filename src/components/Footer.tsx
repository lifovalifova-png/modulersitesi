        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/haberler" className="hover:text-emerald-400 transition">{t('footer.haberler')}</Link></li>
              <li><Link to="/sss" className="hover:text-emerald-400 transition">{t('footer.faq')}</Link></li>
              <li><Link to="/nasil-kullanilir" className="hover:text-emerald-400 transition">{t('footer.howToUse')}</Link></li>
